export const Footer = () => {
    return (
        <div className="pt-12 pb-40 pl-32 pr-44 flex justify-between 2xl:pl-20 2xl:pr-32 2xl:pb-20" style={{ backgroundColor: "#FFEDCC80" }}>
            <div>
                <h2 className="mt-3 uppercase font-bold text-5xl text-blue-700">Chatter</h2>
            </div>
            <div className="flex gap-52 2xl:gap-36">
