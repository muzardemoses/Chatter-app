...
export const SecThree = () => {
    return (
        <div className="px-52 flex flex-col gap-14 mb-28 2xl:px-36 xl:px-14 lg:px-8 md:mb-16 md:gap-10">
            <div className="flex flex-col justify-center items-center gap-6 md:gap-4">
                <h4 className="text-black text-5xl font-bold md:text-4xl">Why you should join chatter</h4>
