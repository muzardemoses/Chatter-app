...
export const SecFive = () => {
    return (
        <div className="py-20 px-52 flex justify-between 2xl:px-32 2xl:gap-10 xl:px-14 lg:px-8 lg:gap-8">
            ...
            <div className="flex flex-col gap-8 lg:w-[62%]">
                <div className="flex flex-col gap-6 ">
                    <h3 className="w-[665px] text-5xl font-bold leading-relaxed 2xl:w-[550px] xl:text-[40px] lg:w-[100%] lg:text-[37px] lg:leading-normal">Write, read and connect with great minds on chatter</h3>
