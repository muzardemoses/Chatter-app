        ...
        <div className="py-20 px-52 flex justify-between 2xl:px-32 2xl:gap-10 xl:px-14 lg:px-8 lg:gap-8 md:py-12 md:flex-col">
            ...
            <div className="flex flex-col gap-8 lg:w-[62%] md:w-full md:gap-5">
                <div className="flex flex-col gap-6 md:gap-3">
                    <h3 className="w-[665px] text-5xl font-bold leading-relaxed 2xl:w-[550px] xl:text-[40px] lg:w-[100%] lg:text-[37px] lg:leading-normal md:leading-[unset] md:text-3xl sm:text-2xl">Write, read and connect with great minds on chatter</h3>
                ...
                <Link to="/register">
                    <button className='w-max px-6 py-3.5 bg-blue-700 text-white font-medium rounded-lg hover:bg-blue-800 transition duration-500 ease-in-out md:py-3 sm:px-5 sm:font-normal'>
                        Get Started
                    </button>
                </Link>
            </div>
