...
export const SecFive = () => {
    return (
        <div className="py-20 px-52 flex justify-between 2xl:px-32 2xl:gap-10 xl:px-14">
            <div className="flex gap-6 items-center">
                <div className="flex flex-col gap-24">
                    <img src={imgOne} alt="woman" className="rounded-full h-40 w-40 xl:w-32 xl:h-32" />
                    <img src={imgTwo} alt="man" className="rounded-full h-40 w-40 xl:w-32 xl:h-32" />
                </div>
                <img src={imgThree} alt="man" className="rounded-full h-40 w-40 xl:w-32 xl:h-32" />
            </div>
            <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-6">
                    <h3 className="w-[665px] text-5xl font-bold leading-relaxed 2xl:w-[550px] xl:text-[40px]">Write, read and connect with great minds on chatter</h3>
