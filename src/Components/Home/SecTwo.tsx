...
export const SecTwo = () => {
    return (
        <div className="py-24 px-20 flex justify-between w-full xl:px-12 lg:px-10" id='about'>
            <div className='w-[53.5%] flex flex-col gap-8'>
            ...
            <img src={divTwoImg} alt="divTwoImg" className="h-[404px] w-[40%] rounded-lg xl:h-[350px]" />
        </div>
    )
}