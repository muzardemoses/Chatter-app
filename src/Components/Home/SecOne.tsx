...
export const SecOne = () => {
    return (
        <div className="w-full relative flex justify-center items-center sec-one-con-height" >
            <div className="z-10 bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center ">
                <div className='w-max flex flex-col gap-9'>
                    <div className='w-max flex flex-col gap-6'>
                        <h1 className='text-white text-5xl leading-relaxed font-bold sec-one-h1-width' >Welcome to Chatter: A Haven for Text-Based Content</h1>
