...
export const SecOne = () => {
    return (
        <div className="h-[765px] w-full relative flex justify-center items-center xl:h-[600px] lg:h-[500px] ">
            <div className="z-10 bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center">
                <div className='w-max flex flex-col gap-9'>
                    <div className='w-max flex flex-col gap-6'>
                        <h1 className='w-[984px] text-white text-5xl leading-relaxed font-bold xl:w-[760px] lg:w-[660px] lg:leading-normal' >Welcome to Chatter: A Haven for Text-Based Content</h1>
                        <p className='w-[740px] text-white text-2xl leading-normal font-medium sec-one-p-width xl:w-[750px] lg:w-[650px]'>Unleash the Power of Words, Connect with Like-minded Readers and Writers</p>
                    </div>
                    <Link to="/register">
